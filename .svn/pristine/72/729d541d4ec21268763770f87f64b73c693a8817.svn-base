 ...
 * author:
 */
public class ExpCHHC extends AbstractExpFile {
    private static Logger log = Logger.getLogger(ExpCHHC.class);
    private static final String SPRING_PATH = "config" + File.separator + "batch" + File.separator +
            "expfiles" + File.separator + "ExpCHHC" + File.separator + "spring.xml";
    private static final String FILE_FN = "CHHC";
    private static final String FILE_APPEND = "CHHC";
    ...
    // 要匯出會員檔的 member
    private List<String> memIds = null;
    // 要匯出會員檔的 bank
    ...
    public ExpFileSetting makeExpFileSetting() {
        ...
        for (int i = 0; i < bankIds.size(); i++) {
            ...
            sb.append(" and P_CODE in ('7707','7423','7418') ");
	...
	private void modifyTrans(ExpDataInfo dataInfo) throws Exception 
	{
		...
		sb.append(" REQ_FILE_NAME='").append(fullFileName).append("'");
		sb.append(" ,REQ_EXP_DATE='").append(sysDate).append("'");
	...
	public static ExpCHHC getInstance() {
        ApplicationContext apContext = new FileSystemXmlApplicationContext(SPRING_PATH);
        ExpCHHC instance = (ExpCHHC) apContext.getBean("expCHHC");
        return instance;
    }
