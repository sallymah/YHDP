 ...
 * --------------------
 */
package tw.com.hyweb.svc.yhdp.batch.framework.expfiles;
 ...
 * author:duncan
 */
public abstract class AbstractByteExpFile extends AbstractBatchBasic {
    private static Logger log = Logger.getLogger(AbstractByteExpFile.class);
    ...
    public void locateFile() throws Exception {
        ...
        final String MERCH_SPECIAL = "111111111111111";
        String workDir = "";
        String relativePath = "";
        try {
        ...
        if (expFileInfo.getFileInfo().getLocalPath().indexOf(MERCH_SPECIAL) != -1) {
            // find "00000000"
            relativePath = relativePath.replaceAll(MERCH_SPECIAL, expFileInfo.getMerchId());
        }
