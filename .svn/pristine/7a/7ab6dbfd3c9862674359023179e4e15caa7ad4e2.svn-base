 ...
 * author: Ivan
 */
public class SumProductInfo implements Serializable {
    private String batchDate = "";
    private String acqmemId = "";
    private List pcodes = new ArrayList();

    public SumProductInfo() {
    }
    ...
    public boolean equals(Object o) {
        ...
        SumProductInfo that = (SumProductInfo) o;
