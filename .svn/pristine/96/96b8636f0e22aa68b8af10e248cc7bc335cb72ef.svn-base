 ...
 * 
 */
public class SumCardEscrowJobFactory extends DAOBatchJobFactory
{

	private Integer overMonth=1;
	...
	public SumCardEscrowJobFactory()
    {
    }
    ...
    {
        return new SumCardEscrowJob((TbMemberInfo)info, overMonth,pCode1,pCode2);
    }
}
