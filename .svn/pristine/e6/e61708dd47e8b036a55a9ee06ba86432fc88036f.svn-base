...
public abstract class AbstractImpFile extends AbstractBatchBasic {
    ...
    protected boolean checkHgCardGp = false;
    ...
    public boolean isCheckCardHgGp() {
    ...
    public abstract ExecuteSqlsInfo afterHandleDataLine() throws Exception;
    ...
    public void process(String[] args) throws Exception {
        ...
        for (int i = 0; i < inctlInfos.size(); i++) {
            try {
                ...
                impFileInfo.setCheckHgCardGp(checkHgCardGp);
                // handle impFileInfo
                handleImpFileInfo();
            }
            catch (Exception ignore) {
