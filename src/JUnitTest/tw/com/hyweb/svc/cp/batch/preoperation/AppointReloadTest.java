 ...
 * 
 */
public class AppointReloadTest extends BatchTestCase
{
    ...
    public void testAppointReloadWSTestTest() throws Exception
    {
        ...
        BatchExecutor.main(new String[] { "config/batch/preoperation/SimulateAppointReload/beans-config.xml", "processor" });
