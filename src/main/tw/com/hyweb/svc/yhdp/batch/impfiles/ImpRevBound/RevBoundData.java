...
public class RevBoundData
{
    private static Logger log = Logger.getLogger(RevBoundData.class);
    ...
    public RevBoundData(Connection connection, Map<String, String> fileData) throws SQLException
    {
    ...
    private String makeReturnBound(String batchDate) {
    	...
    	String sql = "UPDATE TB_CARD SET LIFE_CYCLE='" + lifeCycle 
    			...
    			+ "', CUSTOMER_ID='', SALE_WAY='', UPT_DATE='" + sysDate 
    			+ "', UPT_TIME='" + sysTime 
