...
import tw.com.hyweb.core.yhdp.batch.framework.impfiles.GenErr2TempDirBean;
...
import tw.com.hyweb.core.yhdp.batch.framework.impfiles.InctlBean;
...
public abstract class AbstractImpFile extends AbstractBatchBasic {
    ...
    public List checkDataLine(DataLineInfo lineInfo) throws Exception {
        ...
        // check 2721
        //log.info("check 2721");
        //log.info(mappingInfo.getFields().size());
        //log.info(lineInfo.getFieldDataSize());
    ...
    public abstract List handleDataLine(DataLineInfo lineInfo, int i) throws Exception;
        ...
        try {
            ...
            for (int i = start; i < impFileInfo.getTotRec(); i++) {
                ...
                try {
                    ...
                    // handleDataLine
                    List sqlsInfos = handleDataLine(lineInfo, i);
            ...
            // set rcode by xxxCnt
            if (impFileInfo.getTotRec() == impFileInfo.getFailCnt() && impFileInfo.getTotRec() != 0) {
                thisRcode = Layer1Constants.RCODE_2999_ALLDATAERROR;
            }
