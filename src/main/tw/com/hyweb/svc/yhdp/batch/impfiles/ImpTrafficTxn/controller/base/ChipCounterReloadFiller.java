...
public class ChipCounterReloadFiller implements IBizAction
{
    /**
    ...
    public void doAction(AbstractController ctrl, LMSContext ctx) throws SQLException, TxException
    {
        ...
        if(idx != -1)
        {
            ...
            AwardCouponList chipCounterReload = new AwardCouponList();
            ...
            ac.setIsDw(true);
            ac.setIsCash(true);
            ac.setTxCode(LMSTxCode.BONUS_RELOAD);
            chipCounterReload.add(ac);
            ctx.setChipCounterReload(chipCounterReload);
