 ...
 * author:duncan
 */
public class ImpFmTxnDtl extends AbstractImpFile
{
    private static Logger logger = Logger.getLogger(ImpFmTxnDtl.class);
    private static final String SPRING_PATH = "config" + File.separator + "batch" + File.separator +
            "impfiles" + File.separator + "ImpFmTxnDtl" + File.separator + "spring.xml";
    ...
    public void process(String[] args) throws Exception {
        ...
        ml.startLoading();
        mappingInfo = ml.getMappingInfo("IMPFMTXNDTL");
        if (mappingInfo == null) {
            throw new Exception("mappingInfo IMPFMTXNDTL is null!");
        }
    ...
    public static ImpFmTxnDtl getInstance()
    {
        ApplicationContext apContext = new FileSystemXmlApplicationContext(SPRING_PATH);
        ImpFmTxnDtl instance = (ImpFmTxnDtl) apContext.getBean("ImpFmTxnDtl");
        return instance;
    }

    public static void main(String[] args) {
        ImpFmTxnDtl impTrans = null;
        try {
            ...
            impTrans.setFileName("ImpFmTxnDtl"); //設定MappingInfos.xml tag 對應名稱
            impTrans.run(args);
        }
        catch (Exception ignore) {
            logger.warn("ImpFmTxnDtl run fail:" + ignore.getMessage(), ignore);
