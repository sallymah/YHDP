...
public class bus extends FilenameBean{
	...
	public void initial(String fullFileName, HashMap members) throws Exception {
		...
		String terminalId = AfterSplit[2];
		String DateTime = AfterSplit[3];
		String seqno = AfterSplit[4];
		String unzipDateTime = AfterSplit[6];
		...
		if ( tbMemberInfo != null ){
			...
			setFullFileNameR(getFileNameR() + "_" + transFileAllas + "_" + terminalId 
					+ "_" + DateTime + "_" + seqno + ".DAT_" + unzipDateTime );
		}
	}
