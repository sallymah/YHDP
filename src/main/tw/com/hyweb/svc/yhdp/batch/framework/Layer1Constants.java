...
/**
 * <pre>
 * Layer1Constants for impfiles and expfiles
 * </pre>
 * author:duncan
 */
public class Layer1Constants {
    ...
    public static final String RCODE_2715_ACQMENID_ERR = "2715";
    public static final String RCODE_2716_UPDATE_NODATA = "2716";
    public static final String RCODE_2717_HEADERFILENAME_ERR = "2717";
    
    
    public static final String RCODE_2721_FIELDDATASIZE_ERR = "2721";
    public static final String RCODE_2722_FIELDLENGTH_ERR = "2722";
    public static final String RCODE_2791_GENERALDB_ERR = "2791";
    // --------------------------------------------------------------
    public static final String RCODE_2800_PCODE_ERR = "2800";
    // --------------------------------------------------------------
    public static final String RCODE_0000_OK = "0000";
    public static final String RCODE_2001_SOMEDATAERROR = "2001";
    public static final String RCODE_2999_ALLDATAERROR = "2999";
    // --------------------------------------------------------------
    ...
    //TB_BATCH_RESULT
	// --------------------------------------------------------------
    // TB_BATCH_RESULT.JOB_ID JOB_TIME
    public static final String JOB_ID_DEFAULT = "000";
    public static final String JOB_TIME_DEFAULT = "000000";
    public static final String MEM_LAST = "MEM_LAST";
}
